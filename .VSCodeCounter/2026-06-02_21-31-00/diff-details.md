...
Total : 84 files,  2746 codes, 37 comments, 878 blanks, all 3661 lines
...
| [frontend/src/api/actionPlans.ts](/frontend/src/api/actionPlans.ts) | TypeScript | -59 | 0 | -13 | -72 |
| [frontend/src/api/auth.ts](/frontend/src/api/auth.ts) | TypeScript | -16 | 0 | -4 | -20 |
| [frontend/src/api/chat.ts](/frontend/src/api/chat.ts) | TypeScript | -38 | 0 | -12 | -50 |
| [frontend/src/api/client.ts](/frontend/src/api/client.ts) | TypeScript | -38 | 0 | -9 | -47 |
| [frontend/src/api/goals.ts](/frontend/src/api/goals.ts) | TypeScript | -70 | 0 | -15 | -85 |
| [frontend/src/api/growthRecords.ts](/frontend/src/api/growthRecords.ts) | TypeScript | -45 | 0 | -11 | -56 |
| [frontend/src/api/index.ts](/frontend/src/api/index.ts) | TypeScript | -13 | 0 | -4 | -17 |
| [frontend/src/api/info.ts](/frontend/src/api/info.ts) | TypeScript | -18 | 0 | -6 | -24 |
| [frontend/src/api/profile.ts](/frontend/src/api/profile.ts) | TypeScript | -40 | 0 | -8 | -48 |
| [frontend/src/api/user.ts](/frontend/src/api/user.ts) | TypeScript | -74 | 0 | -13 | -87 |
...
| [frontend/src/components/CompactActionMenu.ts](/frontend/src/components/CompactActionMenu.ts) | TypeScript | -3 | -1 | -2 | -6 |
| [frontend/src/composables/useChartTheme.ts](/frontend/src/composables/useChartTheme.ts) | TypeScript | -45 | 0 | -7 | -52 |
| [frontend/src/composables/useTheme.ts](/frontend/src/composables/useTheme.ts) | TypeScript | -41 | -2 | -11 | -54 |
| [frontend/src/constants/adminPermissions.ts](/frontend/src/constants/adminPermissions.ts) | TypeScript | -39 | -1 | -4 | -44 |
| [frontend/src/env.d.ts](/frontend/src/env.d.ts) | TypeScript | -11 | -2 | -3 | -16 |
| [frontend/src/main.ts](/frontend/src/main.ts) | TypeScript | -7 | 0 | -3 | -10 |
| [frontend/src/router/index.ts](/frontend/src/router/index.ts) | TypeScript | -84 | 0 | -12 | -96 |
| [frontend/src/shims-vue.d.ts](/frontend/src/shims-vue.d.ts) | TypeScript | -5 | 0 | -1 | -6 |
| [frontend/src/stores/auth.ts](/frontend/src/stores/auth.ts) | TypeScript | -77 | 0 | -18 | -95 |
| [frontend/src/style.css](/frontend/src/style.css) | CSS | -963 | 0 | -133 | -1,096 |
| [frontend/src/utils/apiError.ts](/frontend/src/utils/apiError.ts) | TypeScript | -32 | 0 | -6 | -38 |
| [frontend/src/utils/growthTrendChartOptions.ts](/frontend/src/utils/growthTrendChartOptions.ts) | TypeScript | -142 | 0 | -6 | -148 |
| [frontend/src/utils/localDate.ts](/frontend/src/utils/localDate.ts) | TypeScript | -6 | -1 | -1 | -8 |
| [frontend/src/utils/number.ts](/frontend/src/utils/number.ts) | TypeScript | -7 | 0 | -1 | -8 |
| [frontend/src/utils/ws.ts](/frontend/src/utils/ws.ts) | TypeScript | -21 | -5 | -6 | -32 |
