...
const extracted = ref<ProfileExtractionResult | null>(null)
    ...
    <section class="page-header glass-card panel hero-frame reveal">
      <div class="title-row">
        ...
        <div class="hero-actions">
          <button class="button button--ghost" :disabled="refreshing || loading" type="button" @click="loadProfile">
            重新加载
          </button>
          <button class="button button--primary" :disabled="refreshing || loading" type="button" @click="refreshFromChat">
            从聊天刷新
          </button>
        </div>
      </div>
